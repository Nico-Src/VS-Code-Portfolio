class BrickLib{
    ...
    static bricks = [
        ...
        {
            name: '1x4x3 with Hollow Studs',
            shortName: '1x4x3 with Hollow Studs',
            height: .705,
            width: 4,
            depth: 1,
            path: '4215b.glb',
            boundingBoxOffset: new BABYLON.Vector3(0,-.475,0),
            offset: new BABYLON.Vector3(0.1,.475,0),
            category: 'Panel',
            canPlaceOnTop: true,
        },
        {
            name: 'Brick 45 2x3',
            shortName: 'Brick 45 2x3',
            height: .235,
            width: 3,
            depth: 2,
            path: '3038.glb',
            boundingBoxOffset: new BABYLON.Vector3(0,0,.1),
            offset: new BABYLON.Vector3(0,0,0),
            category: 'Slope',
            canPlaceOnTop: true,
        },
        {
            name: '4H with Rounded Top',
            shortName: '4H with Rounded Top',
            height: .940,
            width: 1,
            depth: 1,
            path: '3957a.glb',
